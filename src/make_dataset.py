...
def main(args):
    ...
    train = preprocessor.get_dataset(config['train_json_path'], args.n_workers, config['train_dataset'])
    ...
    valid = preprocessor.get_dataset(config['valid_json_path'], args.n_workers, config['valid_dataset'])
    ...
    test = preprocessor.get_dataset(config['test_json_path'], args.n_workers, config['test_dataset'])
